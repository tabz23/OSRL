...
def train(args: BCTrainConfig):
    ...
    process_bc_dataset(data, args.cost_limit, args.gamma, bc_mode="safe")##training BC safe
    ...
    for step in trange(args.update_steps, desc="Training"):
        ...
        observations, _, actions, _, _, _ = [b.to(torch.float32).to(args.device) for b in batch]
...
# python "/Users/i.k.tabbara/Documents/python directory/OSRL/examples/train/train_bc_gaussian_actor.py" --task OfflineHopperVelocityGymnasium-v1 --device mps
...
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 0 --temp 1 --detach True --batch_size 256  --device="mps" --num_action_samples 10
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 1 --temp 1 --detach True --batch_size 256 --device="mps" --num_action_samples 10
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 1 --temp 0.7 --detach True --batch_size 256 --device="mps" --num_action_samples 10
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 1 --temp 0.5 --detach True --batch_size 256 --device="mps" --num_action_samples 10
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 1 --temp 1 --detach False --batch_size 256  --device="mps" --num_action_samples 10
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 1 --temp 0.7 --detach False --batch_size 256  --device="mps" --num_action_samples 10
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 1 --temp 0.5 --detach False --batch_size 256  --device="mps" --num_action_samples 10

# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 0 --temp 1 --detach True --batch_size 256  --device="mps" --num_action_samples 10 --seed 1
python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 0 --temp 1 --detach True --batch_size 256 --device="mps" --num_action_samples_cql 10 --seed 5 --train_steps 50000 --w_grad 2
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 1 --temp 0.7 --detach True --batch_size 256 --device="mps" --num_action_samples 10 --seed 4
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 0.1 --temp 0.5 --detach True --batch_size 256 --device="mps" --num_action_samples 10 --seed 3
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 0 --temp 1 --detach True --batch_size 256  --device="mps" --num_action_samples 10
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 1 --temp 1 --detach True --batch_size 256 --device="mps" --num_action_samples 10 --seed 5 
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 0.1 --temp 0.7 --detach True --batch_size 256 --device="mps" --num_action_samples 10 --seed 7
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 1 --temp 0.5 --detach True --batch_size 256 --device="mps" --num_action_samples 10 --seed 8
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 0.1 --temp 1 --detach False --batch_size 256  --device="mps" --num_action_samples 10
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 0.1 --temp 0.7 --detach False --batch_size 256  --device="mps" --num_action_samples 10
# python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 0.1 --temp 0.5 --detach False --batch_size 256  --device="mps" --num_action_samples 10
...
python examples/research/check/trainer.py --task OfflineHopperVelocityGymnasium-v1  --cql 0.5 --temp 0.7 --detach True --batch_size 256 --device="mps" --num_action_samples 10 --seed 5


# chmod +x "/Users/i.k.tabbara/Documents/python directory/OSRL/examples/research/check/training_hopper.sh"
#caffeinate -i "/Users/i.k.tabbara/Documents/python directory/OSRL/examples/research/check/training_hopper.sh"

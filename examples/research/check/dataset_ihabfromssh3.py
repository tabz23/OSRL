...
class TransitionDataset(IterableDataset):
    ...
    Args:
        ...
        trajectory_split (bool): If True, split by trajectories instead of individual transitions.  #i added this
    """
    ...
    def __init__(self,
                 ...
                 trajectory_split: bool = False):  #i added this
        ...
        self.trajectory_split = trajectory_split  #i added this
        ...
        # Choose splitting strategy based on trajectory_split flag  #i added this
        if self.trajectory_split:  #i added this
            self._split_by_trajectories()  #i added this
        else:  #i added this
            self._split_by_transitions()  #i added this

    def _split_by_transitions(self):  #i added this
        """Original splitting method - by individual transitions"""  #i added this
    ...
    def _split_by_trajectories(self):  #i added this
        """New splitting method - by complete trajectories"""  #i added this
        # Find trajectory boundaries using done flags  #i added this
        done_flags = self.dataset["done"]  #i added this
        trajectory_ends = np.where(done_flags == 1)[0]  #i added this
        
        # Create trajectory start and end indices  #i added this
        trajectory_starts = np.concatenate([[0], trajectory_ends[:-1] + 1])  #i added this
        trajectory_ends = trajectory_ends  #i added this
        
        num_trajectories = len(trajectory_starts)  #i added this
        print(f"Found {num_trajectories} trajectories in dataset")  #i added this
        
        # Split trajectories into train/val  #i added this
        traj_indices = np.arange(num_trajectories)  #i added this
        np.random.shuffle(traj_indices)  #i added this
        
        num_train_trajs = int(num_trajectories * self.train_ratio)  #i added this
        train_traj_indices = traj_indices[:num_train_trajs]  #i added this
        val_traj_indices = traj_indices[num_train_trajs:]  #i added this
        
        print(f"Train trajectories: {len(train_traj_indices)}, Val trajectories: {len(val_traj_indices)}")  #i added this
        
        # Get transition indices for each split  #i added this
        self.train_indices = []  #i added this
        for traj_idx in train_traj_indices:  #i added this
            start = trajectory_starts[traj_idx]  #i added this
            end = trajectory_ends[traj_idx]  #i added this
            self.train_indices.extend(range(start, end + 1))  #i added this
        
        self.val_indices = []  #i added this
        for traj_idx in val_traj_indices:  #i added this
            start = trajectory_starts[traj_idx]  #i added this
            end = trajectory_ends[traj_idx]  #i added this
            self.val_indices.extend(range(start, end + 1))  #i added this
        
        self.train_indices = np.array(self.train_indices)  #i added this
        self.val_indices = np.array(self.val_indices)  #i added this
        
        print(f"Train transitions: {len(self.train_indices)}, Val transitions: {len(self.val_indices)}")  #i added this
        
        if self.split == 'train':  #i added this
            self.indices = self.train_indices  #i added this
        elif self.split == 'val':  #i added this
            self.indices = self.val_indices  #i added this
        else:  #i added this
            raise ValueError("split must be one of 'train' or 'val'")  #i added this

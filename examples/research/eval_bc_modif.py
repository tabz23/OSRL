...
def eval(args: EvalConfig):
    ...
    env = wrap_env(env = gym.make("SafetyPointGoal1Gymnasium-v0",render_mode="human"))#ADDED THIS cfg["task"] changed form OfflinePointGoal1Gymnasium-v0 to SafetyPointGoal1Gymnasium-v0
